...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OMSWebMini.Model.Category", b =>
                {
            ...
            modelBuilder.Entity("OMSWebMini.Model.Customer", b =>
                {
            ...
            modelBuilder.Entity("OMSWebMini.Model.CustomersByCountry", b =>
                {
            ...
            modelBuilder.Entity("OMSWebMini.Model.Employee", b =>
                {
            ...
            modelBuilder.Entity("OMSWebMini.Model.Order", b =>
                {
            ...
            modelBuilder.Entity("OMSWebMini.Model.OrderDetail", b =>
                {
                    b.Property<int>("OrderId")
                        .HasColumnType("int")
                        .HasColumnName("OrderID");
            ...
            modelBuilder.Entity("OMSWebMini.Model.OrdersByCountry", b =>
                {
                    b.Property<string>("CountryName")
                        .HasMaxLength(100)
                        .HasColumnType("nchar(100)")
            ...
            modelBuilder.Entity("OMSWebMini.Model.Product", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OMSWebMini.Model.ProductsByCategory", b =>
                {
                    b.Property<string>("CategoryName")
                        .HasMaxLength(100)
                        .HasColumnType("nchar(100)")
            ...
            modelBuilder.Entity("OMSWebMini.Model.PurchasesByCustomer", b =>
                {
                    b.Property<string>("CompanyName")
                        .HasMaxLength(100)
                        .HasColumnType("nchar(100)")
            ...
            modelBuilder.Entity("OMSWebMini.Model.SalesByCategory", b =>
                {
                    b.Property<string>("CategoryName")
                        .HasMaxLength(100)
                        .HasColumnType("nchar(100)")
            ...
            modelBuilder.Entity("OMSWebMini.Model.SalesByCountry", b =>
                {
                    b.Property<string>("CountryName")
                        .HasMaxLength(100)
                        .HasColumnType("nchar(100)")
            ...
            modelBuilder.Entity("OMSWebMini.Model.SalesByEmployee", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OMSWebMini.Model.Shipper", b =>
                {
            ...
            modelBuilder.Entity("OMSWebMini.Model.Summary", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnName("ID");
                    ...
                    b.Property<decimal>("MaxCheck")
                        .HasColumnType("decimal(18,10)");

                    b.Property<decimal>("MinCheck")
                        .HasColumnType("decimal(18,10)");

                    b.Property<int>("OrdersQuantity")
                        .HasColumnType("int");

                    b.Property<decimal>("OverallSales")
                        .HasColumnType("decimal(18,10)");
            ...
            modelBuilder.Entity("OMSWebMini.Model.Supplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OMSWebMini.Model.Employee", b =>
                {
                    b.HasOne("OMSWebMini.Model.Employee", "ReportsToNavigation")
            ...
            modelBuilder.Entity("OMSWebMini.Model.Order", b =>
                {
                    b.HasOne("OMSWebMini.Model.Customer", "Customer")
                        .WithMany("Orders")
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("FK_Orders_Customers");

                    b.HasOne("OMSWebMini.Model.Employee", "Employee")
                        .WithMany("Orders")
                        .HasForeignKey("EmployeeId")
                        .HasConstraintName("FK_Orders_Employees");

                    b.HasOne("OMSWebMini.Model.Shipper", "ShipViaNavigation")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("OMSWebMini.Model.OrderDetail", b =>
                {
                    b.HasOne("OMSWebMini.Model.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .HasConstraintName("FK_Order_Details_Orders")
                        .IsRequired();

                    b.HasOne("OMSWebMini.Model.Product", "Product")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("OMSWebMini.Model.Product", b =>
                {
                    b.HasOne("OMSWebMini.Model.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .HasConstraintName("FK_Products_Categories");

                    b.HasOne("OMSWebMini.Model.Supplier", "Supplier")
                        .WithMany("Products")
